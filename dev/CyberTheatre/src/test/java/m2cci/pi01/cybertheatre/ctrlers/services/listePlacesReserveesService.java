...
import m2cci.pi01.cybertheatre.DAO.listePlacesReserveesDAO;
 ...
 * @author phil
 */
@WebServlet(name = "listePlacesReserveesService", urlPatterns = {"/listePlacesReserveesService"})
public class listePlacesReserveesService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JSONArray placeReservees = listePlacesReserveesDAO.listePlaceReserveesJSON(bdSQL, representation);

            response.setContentType("application/json; charset=UTF-8");
            PrintWriter out = response.getWriter();
            out.print(placeReservees);
            out.close();
